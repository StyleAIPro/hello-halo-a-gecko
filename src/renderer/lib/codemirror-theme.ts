/**
 * CodeMirror Theme for AICO-Bot
 *
 * Creates a theme that matches AICO-Bot's CSS variable-based theme system.
 * The theme automatically adapts to light/dark mode via CSS variables.
 *
 * Design principles:
 * - Use AICO-Bot CSS variables (--background, --foreground, etc.)
...
/**
 * Base editor theme using AICO-Bot CSS variables
 * Uses CSS variables that automatically adapt to light/dark mode
 */
export const aicoBotEditorTheme = EditorView.theme(
  {
 ...
 */
export const aicoBotHighlightStyle = HighlightStyle.define([
  // Comments
...
/**
 * Complete AICO-Bot theme for CodeMirror
