  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {spaceName && (
          <span className="block text-[11px] text-muted-foreground/70 truncate">{spaceName}</span>
        )}
      </div>
      ...
      {isWaiting && <AlertCircle className="flex-shrink-0 w-3.5 h-3.5 text-orange-400" />}
    </button>
  );
}
