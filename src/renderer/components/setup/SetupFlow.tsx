...
export function SetupFlow() {
  ...
  if (step === 'select') {
    return (
      <LoginSelector onSelectProvider={handleSelectProvider} onSelectCustom={handleSelectCustom} />
    );
  }
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          {deviceCodeInfo && (
            <div className="mt-4 p-6 bg-muted/50 border border-border rounded-lg text-center">
              <p className="text-sm text-muted-foreground mb-2">{t('Visit this URL to login:')}</p>
              <a
              ...
              <p className="text-sm text-muted-foreground mt-4 mb-2">{t('Enter this code:')}</p>
