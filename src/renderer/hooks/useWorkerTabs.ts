...
export function useWorkerTabs({ spaceName, isGenerating }: UseWorkerTabsOptions): UseWorkerTabsResult {
  ...
  return { activeTabId, tabs, unreadWorkers, activeWorkerSession, isViewingWorker, handleTabChange }
}
