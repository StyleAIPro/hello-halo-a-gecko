...
function ensureInitialized(): boolean {
  ...
  try {
    ...
    SetWindowPos_ = user32.func('bool __stdcall SetWindowPos(void* hWnd, void* hWndInsertAfter, int X, int Y, int cx, int cy, uint uFlags)')
    DwmFlush_ = dwmapi.func('int __stdcall DwmFlush(void)')
    EnumChildWindows_ = user32.func('bool __stdcall EnumChildWindows(void* hWndParent, void* lpEnumFunc, uintptr_t lParam)')
    GetClassNameW_ = user32.func('int __stdcall GetClassNameW(void* hWnd, uint16* lpClassName, int nMaxCount)')
