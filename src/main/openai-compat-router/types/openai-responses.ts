...
): item is OpenAIResponsesInputMessage {
  return 'role' in item;
}

export function isFunctionCall(
  item: OpenAIResponsesInputItem,
): item is OpenAIResponsesFunctionCall {
  return 'type' in item && item.type === 'function_call';
}

export function isFunctionCallOutput(
  item: OpenAIResponsesInputItem,
): item is OpenAIResponsesFunctionCallOutput {
  return 'type' in item && item.type === 'function_call_output';
}

export function isMessageOutput(
  item: OpenAIResponsesOutputItem,
): item is OpenAIResponsesMessageOutput {
  return item.type === 'message';
}

export function isFunctionCallOutput2(
  item: OpenAIResponsesOutputItem,
): item is OpenAIResponsesFunctionCallOutput2 {
  return item.type === 'function_call';
}

export function isReasoningOutput(
  item: OpenAIResponsesOutputItem,
): item is OpenAIResponsesReasoningOutput {
  return item.type === 'reasoning';
}

export function isInputText(
  part: OpenAIResponsesInputContentPart,
): part is OpenAIResponsesInputText {
  return part.type === 'input_text';
}

export function isInputImage(
  part: OpenAIResponsesInputContentPart,
): part is OpenAIResponsesInputImage {
  return part.type === 'input_image';
}

export function isOutputText(
  part: OpenAIResponsesOutputContentPart,
): part is OpenAIResponsesOutputText {
