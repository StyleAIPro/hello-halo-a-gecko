...
| 2026-05-10 | bugfix: 远程代理 disallowedTools 移除 Agent/Task，改为依赖系统提示词条件规则；fallback 系统提示词同步更新为"Do NOT proactively" — `packages/remote-agent-proxy/src/claude-manager.ts` | @misakamikoto | bugfix-subagent-ignored-v1 |
