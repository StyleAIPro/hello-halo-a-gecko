...
ターミナルに触れることなく、AI Agent の全機能を体験できます。AICO-Bot は、ビジュアルでクロスプラットフォームなデスクトップ体験をすべての人に提供します—オープンソースで無料。
...
> **AICO-Bot** は Claude Code CLI をビジュアル AI コンパニオンに変えます。
...
### 本物の Agent ループ
チャットだけではありません。AICO-Bot は **実際に行動できます** — コードを書き、ファイルを作成し、コマンドを実行し、タスクが完了するまで反復します。
...
### リモートアクセス
スマートフォンや任意のブラウザからデスクトップの AICO-Bot を制御。どこからでも作業 — 病院のベッドからでも（実話）。
...
| プラットフォーム | ダウンロード | 要件 |
|----------|----------|--------------|
| **macOS** (Apple Silicon) | [.dmg をダウンロード](https://github.com/openkursar/hello-aico-bot/releases/latest) | macOS 11+ |
| **macOS** (Intel) | [.dmg をダウンロード](https://github.com/openkursar/hello-aico-bot/releases/latest) | macOS 11+ |
| **Windows** | [.exe をダウンロード](https://github.com/openkursar/hello-aico-bot/releases/latest) | Windows 10+ |
| **Linux** | [.AppImage をダウンロード](https://github.com/openkursar/hello-aico-bot/releases/latest) | Ubuntu 20.04+ |
...
1. **AICO-Bot を起動** して API キーを入力（Anthropic 推奨）
...
AICO-Bot は開発者だけのものではありません。私たちが見てきたもの：
...
障壁はもはや AI の能力ではありません。**アクセシビリティです。** AICO-Bot はその障壁を取り除きます。
...
- [GitHub Discussions](https://github.com/openkursar/hello-aico-bot/discussions) — 質問＆アイデア
- [Issues](https://github.com/openkursar/hello-aico-bot/issues) — バグレポート＆機能リクエスト
...
- **スターをつけてください** — 他の人が AICO-Bot を見つけやすくなります
- **ストーリーを共有してください** — 何を作ったか聞きたいです
- **リンクしてください** — 例：`Inspired by [AICO-Bot](https://github.com/openkursar/hello-aico-bot)`

---

## AICO-Bot の背景にあるストーリー
...
AICO-Bot が素晴らしいものを作る手助けになったら、ぜひ聞かせてください。

**このリポジトリに Star を** して、他の人が AICO-Bot を発見する手助けをしてください。
